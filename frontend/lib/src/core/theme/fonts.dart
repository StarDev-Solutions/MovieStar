...
TextStyle get labelStyle2 => TextStyle(fontFamily: 'Axiforma', fontSize: 15.s3, fontWeight: FontWeight.w400, decoration: TextDecoration.none);
TextStyle get labelUsuarios => TextStyle(fontFamily: 'Axiforma', fontSize: 10.s3, fontWeight: FontWeight.w400, color: colorHint, decoration: TextDecoration.none);
...
TextStyle get sinopseStyle => TextStyle(fontFamily: 'Axiforma', fontSize: 13.s3, fontWeight: FontWeight.w400, color: colorHint, decoration: TextDecoration.none);
TextStyle get dataLancamentoStyle => TextStyle(fontFamily: 'Axiforma', fontSize: 12.s3, fontWeight: FontWeight.w400, color: colorHint, decoration: TextDecoration.none);

TextStyle get nomeAtorStyle => TextStyle(fontFamily: 'Axiforma', fontSize: 13.s3, fontWeight: FontWeight.bold, color: colorLabelOnPrimary, decoration: TextDecoration.none);
TextStyle get nomePersonagemStyle => TextStyle(fontFamily: 'Axiforma', fontSize: 11.s3, fontWeight: FontWeight.w400, color: colorLabelOnPrimary, decoration: TextDecoration.none);
